...
const DeleteModal = ({ isOpen, onClose, onConfirm, itemName }) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-white border-t-8 border-red-500 rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden animate-in zoom-in-95 duration-200">
                {/* Header/Icon Section */}
                ...
                <div className="p-4 bg-gray-50 flex gap-3">
                    ...
                    <button
                        onClick={onConfirm}
                        className="flex-1 px-4 py-2.5 rounded-xl bg-red-500 text-white font-medium hover:bg-red-600 transition-shadow hover:shadow-lg shadow-red-200 cursor-pointer flex items-center justify-center gap-2 text-sm"
                    >
                        <FaTrash size={14} />
                        Delete
                    </button>
