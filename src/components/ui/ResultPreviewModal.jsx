          ...
          {studentsResults.map((student) => {
            ...
            return (
              <div
                ...
                className="result-card print:page-break-after-always mb-8 print:mb-0"
              >
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    <div className="flex flex-col items-start p-3 rounded">
                      ...
                      <div className="flex items-start">
                        <p>
                          <strong>Obtain/Total Marks:</strong>{" "}
                          {student.termSummary.firstTerm.obtained} /{" "}
                          {student.termSummary.firstTerm.total}
                        </p>
                        <p>
                          <strong>Percentage:</strong>{" "}
                          {student.termSummary.firstTerm.percentage}%
                        </p>
                        <p>
                          <strong>Grade:</strong>{" "}
                          {student.termSummary.firstTerm.grade}
                        </p>
                        <p>
                          <strong>Status:</strong>{" "}
                          {student.termSummary.firstTerm.status}
                        </p>
                      </div>
                    </div>
                    <div className="flex flex-col items-start p-3 rounded">
                      ...
                      <div className="flex items-start">
                        <p>
                          <strong>Obtain/Total Marks:</strong>{" "}
                          {student.termSummary.secondTerm.obtained} /{" "}
                          {student.termSummary.secondTerm.total}
                        </p>
                        <p>
                          <strong>Percentage:</strong>{" "}
                          {student.termSummary.secondTerm.percentage}%
                        </p>
                        <p>
                          <strong>Grade:</strong>{" "}
                          {student.termSummary.secondTerm.grade}
                        </p>
                        <p>
                          <strong>Status:</strong>{" "}
                          {student.termSummary.secondTerm.status}
                        </p>
                      </div>
                    </div>
                  </div>
                      ...
                      {student.subjects?.map((subject, idx) => {
                        const subjectPercentage =
                          subject.total > 0
                            ...
                            : 0;
                        const subjectGrade = getGradeFromPercentage(
                        ...
                        return (
                          <tr key={idx}>
                            ...
                            <td className="border border-black px-4 py-2">
                              {subject.firstTermObtained || "-"}/
                              {subject.firstTermTotal || "-"}
                            </td>
                            <td className="border border-black px-4 py-2">
                              {subject.secondTermObtained || "-"}/
                              {subject.secondTermTotal || "-"}
                            </td>
                            <td className="border border-black px-4 py-2">
                              {subject.total}
                            </td>
                ...
                <section className="border border-black p-4 mb-6">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <p>
                      <strong>Overall Percentage:</strong> {avgPercentage}%
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      {Number(avgPercentage) >= 40 ? "Pass" : "Fail"}
                    </p>
                    <p>
                      <strong>Remarks:</strong>{" "}
                      {Number(avgPercentage) >= 40
