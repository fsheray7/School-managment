  ...
  return (
    <div className={`flex flex-col gap-2 ${className}`}>
      ...
      <div className="flex flex-wrap items-center gap-3">
        <label
          className="flex items-center gap-2 px-6 py-3 bg-white rounded-lg cursor-pointer hover:scale-101 transform duration-300  transition-all font-medium whitespace-nowrap text-[var(--primary-color)]"
        >
          <FaUpload size={14} />
