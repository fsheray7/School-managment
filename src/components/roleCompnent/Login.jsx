...
const Login = ({ onLoginSuccess }) => {
  ...
  return (
    <>
      <form className="w-full max-w-xl flex flex-col  gap-4 sm:gap-5 md:gap-6 px-4 sm:px-6 md:px-2" onSubmit={handleSubmit}>
        ...
        <button
          type="submit"
          className="mt-4 md:translate-x-6  text-center  bg-[#0C46C4] hover:bg-blue-800 active:bg-blue-900 text-white py-2.5 sm:py-3 md:py-3 rounded-lg sm:rounded-xl md:rounded-2xl text-xs sm:text-sm md:text-base font-bold w-full max-w-sm "
        >
          Login
        </button>
