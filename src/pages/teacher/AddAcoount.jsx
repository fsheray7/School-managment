  ...
  return (
    <section className="relative flex flex-col items-center min-h-screen w-full bg-white overflow-hidden px-4 pt-26 pb-10">
      ...
      >
        ...
        <p
          className=" absolute top-23 md:top-30 lg:top-20   text-xs sm:text-sm md:text-base lg:text-sm font-medium"
      ...
      <form className="w-full max-w-2xl mt-36 md:mt-30 grid grid-cols-2 flex-col cols-2 gap-4">
        ...
        {/* Submit */}
        <button
          className="mt-4 text-white font-semibold rounded-md py-3 text-sm hover:brightness-90 transition-all active:scale-95 shadow-md"
        ...
        <Link
          ...
          className="mt-4 text-center text-white font-semibold rounded-md py-3 text-md hover:brightness-90 transition-all active:scale-95 shadow-md"
          style={{ backgroundColor: "var(--primary-color)" }}
        >
          Go Back
        </Link>
