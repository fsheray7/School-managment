...
import StudentSidebar from "../../components/studentcomp/sidebar/StudentSidebar";
...
const StudentDashboard = () => {
  ...
  return (
    <section className="flex flex-col items-center justify-start  w-full bg-white overflow-hidden gap-2 px-4 ">
...
<div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-3 gap-3 sm:gap-5 w-full justify-items-center   mt-6">
  ...
  <div className="flex flex-col items-center w-full sm:max-w-none">
    <Link to="/attendance-student" className="w-full bg-[#E8F8F6] rounded-xl p-3 sm:p-4 flex justify-center items-center shadow-sm cursor-pointer">
      <img
  ...
  <div className="flex flex-col items-center w-full max-w-[120px] sm:max-w-none">
    <Link to="/homework-student" className="w-full bg-[#E8F8F6] rounded-xl p-3 sm:p-4 flex justify-center items-center shadow-sm cursor-pointer">
      <img
  ...
  <div className="flex flex-col items-center w-full max-w-[120px] sm:max-w-none">
    <Link to="/results-student" className="w-full bg-[#E8F8F6] rounded-xl p-3 sm:p-4 flex justify-center items-center shadow-sm cursor-pointer">
  ...
  <div className="flex flex-col items-center w-full max-w-[120px] sm:max-w-none">
    <Link to="/exam-routine-student" className="w-full bg-[#E8F8F6] rounded-xl p-3 sm:p-4 flex justify-center items-center shadow-sm cursor-pointer">
  ...
  <div className="flex flex-col items-center w-full max-w-[120px] sm:max-w-none">
    <Link to='/questions' className="w-full bg-[#E8F8F6] rounded-xl p-3 sm:p-4 flex justify-center items-center shadow-sm cursor-pointer">
  ...
  <div className="flex flex-col items-center w-full max-w-[120px] sm:max-w-none">
    <Link to="/quiz" className="w-full bg-[#E8F8F6] rounded-xl p-3 sm:p-4 flex justify-center items-center shadow-sm cursor-pointer">
