      ...
      >
        ...
        <div className="flex flex-col gap-2 ">
          <p className="flex flex-col font-semibold">
            Full Name: <span className="  text-[#000000]">Prajesh Shakya</span>
          </p>
          <p className="flex flex-col font-semibold">
            Grade: <span className="text-[#000000]">9 'B'</span>
          </p>
          <p className="flex flex-col font-semibold">
            Roll No: <span className="text-[#000000]">21</span>
          </p>
          <p className="flex flex-col font-semibold">
            Address: <span className="text-[#000000]">Prajesh Shakya</span>
          </p>
          <p className="flex flex-col font-semibold">
            Guardian's Name:{" "}
            <span className="text-[#000000]">Prajesh Shakya</span>
          </p>

          <p className="flex flex-col font-semibold">
            Guardian's Contact:{" "}
            <span className="text-[#000000]">0987654321</span>
          </p>
        </div>
      </div>
