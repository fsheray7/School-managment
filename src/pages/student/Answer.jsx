    ...
    <section className="w-full  bg-white flex flex-col items-center justify-center gap-10 px-8  pb-6">
      ...
      <div className="w-full gap-4 text-[#000000] flex flex-col px-4 ">
        ...
        <p>
          The standard Lorem Ipsum passage. "Lorem ipsum dolor sit amet,
          consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
          labore et dolore magna aliqua? The standard Lorem Ipsum passage.
          "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua? The
          standard Lorem Ipsum passage. "Lorem ipsum dolor sit amet, consectetur
          adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
          magna aliqua? The standard Lorem Ipsum passage. "Lorem ipsum dolor sit
