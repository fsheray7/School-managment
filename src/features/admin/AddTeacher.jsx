...
const AddTeacher = () => {
  ...
  return (
    <section className="relative flex flex-col items-center min-h-screen w-full bg-white overflow-hidden px-4  pt-20">
      ...
      {/* Form */}
      <form className="w-full max-w-2xl mt-36 md:mt-30 grid grid-cols-2 flex-col cols-2 gap-4" onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col">
          ...
          <div className="flex border border-[#0C46C4] rounded-md px-4 justify-between bg-white py-2 gap-3">
            <div className="flex items-center gap-2">
              <p className="text-sm text-[#0C46C4]">Regular</p>
              <input
                type="radio"
                name="type"
            ...
            <div className="flex items-center gap-2">
              <p className="text-sm text-[#0C46C4]">Contractual</p>
              <input
                type="radio"
                name="type"
                className="w-4 h-4 border border-[#0C46C4] rounded cursor-pointer"
        ...
        {/* Submit */}
        <button
          className="mt-4  bg-[#0C46C4] hover:bg-[#08308d] text-white font-semibold rounded-md py-2 text-sm"
        >
          Add Teacher
        </button>
        <button onClick={() => navigate('/teachers')}
          className="mt-4  text-center bg-[#0C46C4] hover:bg-[#08308d] text-white font-semibold rounded-md py-2 text-md"
        >
          Go Back
        </button>
      </form>
